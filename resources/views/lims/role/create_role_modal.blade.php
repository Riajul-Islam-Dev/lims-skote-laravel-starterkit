    ...
    <div class="modal fade" id="addRoleModal" tabindex="-1" aria-labelledby="addRoleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <h6 class="mt-2 ms-3">Please fill up the new Role form carefully. Fields marked with <span
                        style="color: red">*</span>
                    are required.</h6>
                <form action="{{ route('saveRole') }}" method="POST" id="create_role_form"
                    enctype="multipart/form-data">
                    @csrf
                    <div class="modal-body">
                        <div class="row my-2">
                            <div class="col-6">
                                <x-lims.forms.input.label for="role_name" label="Role Name" star="*" />
                                <x-lims.forms.input.text name="role_name" id="role_name" placeholder="Role Name" />
                                <span class="text-danger error-text role_name_error"></span>
                            </div>
                            <div class="col-6">
                                <x-lims.forms.input.label for="role_section" label="Role Section" star="*" />
                                <x-lims.forms.input.select name="role_section" id="role_section">
                                ...
                                <span class="text-danger error-text role_section_error"></span>
                            </div>
                        </div>
                        <div class="row my-2">
                            <div class="col-6">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success waves-effect btn-label waves-light"
                            id="add_role_btn"><i class="bx bx-check-double label-icon"></i><span id="add_role_btn_span">
