<div class="container">
    <div class="modal fade" id="addCivilCaseModal" tabindex="-1" aria-labelledby="addCivilCaseModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addCivilCaseModalLabel">Add new Civil Case:</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <h6 class="mt-2 ms-3">Please fill up the new Civil Case form carefully. Fields marked with <span
                        style="color: red">*</span>
                    are required.</h6>
                <form action="{{ route('saveCivilCase') }}" method="POST" id="create_civil_case_form"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="submit" class="btn btn-success waves-effect btn-label waves-light"
                            id="add_civil_case_btn"><i class="bx bx-check-double label-icon"></i> <span
                                id="add_civil_case_btn_span">Create Civil Case</span></button>
                    </div>
                </form>
            </div>
        </div>
