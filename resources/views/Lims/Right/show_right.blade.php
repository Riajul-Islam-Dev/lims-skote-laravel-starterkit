        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="card-title">Right List:</h4>
                    <p class="card-title-desc">All Rights are listed in the data table here.
                    </p>

                    <table id="datatable-buttons" class="table table-bordered dt-responsive nowrap w-100">
                        <a href="{{ url('/add_right') }}" class="btn btn-success my-3"><i
                                class="fa-solid fa-circle-plus"></i> Add new Right</a>
                        <thead>
                            <tr>
                                <th>ID</th>
                                <th>Right Name</th>
