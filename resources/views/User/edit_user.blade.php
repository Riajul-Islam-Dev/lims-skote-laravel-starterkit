                ...
                <div class="card-body">
                    ...
                    <form action="{{ url('/update_user') }}" method="POST" class="needs-validation" novalidate
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input type="text" class="form-control" id="name" name="name"
                                        value="{{ $edit_user_data->name }}" placeholder="Name" required>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 position-relative">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email"
                                        value="{{ $edit_user_data->email }}" placeholder="Email" required>
                                    <div class="valid-tooltip">
                                        Looks good!
                                    </div>
                                    <div class="invalid-tooltip">
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3 position-relative">
                                    <label for="userdob">Date of Birth <span style="color: red">*</span></label>
                                    <div class="input-group" id="datepicker1">
                                        <input type="text" class="form-control placeholder="dd-mm-yyyy"
                                            data-date-format="dd-mm-yyyy" data-date-container='#datepicker1'
                                            data-date-end-date="0d" value="{{ $edit_user_data->dob }}"
